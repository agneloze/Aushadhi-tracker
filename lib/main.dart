...
void main() async {
  ...
  // Initialize Supabase — always succeeds even without a session
  await Supabase.initialize(
    url: 'https://oniurthtwpvhgflzzmac.supabase.co',
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9uaXVydGh0d3B2aGdmbHp6bWFjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY5NjYzMTYsImV4cCI6MjA5MjU0MjMxNn0.mIdWrvpkNntr6kRWLHzDCHj-ndejmjNkdp88SY3woGA',
  );
